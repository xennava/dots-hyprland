...
for i = 1, 1 do
	hl.bind("SUPER + ALT + " .. i, hl.dsp.no_op(), { description = "Window: Send to workspace " .. i })
end
...
local scroll_binds = {
	{ "SUPER + mouse_down", "+1" },
	{ "SUPER + mouse_up", "-1" },
	{ "CTRL + SUPER + mouse_down", "r+1" },
	{ "CTRL + SUPER + mouse_up", "r-1" },
}

for _, b in ipairs(scroll_binds) do
	hl.bind(b[1], hl.dsp.focus({ workspace = b[2] }))
end
--## Special
...
--#/# bind = CTRL + SUPER, [ / ] / Up / Down,, -- Move workspace focus (-1, +1, -5, +5)
local workspace_binds = {
	{ "CTRL + SUPER + BracketLeft", "-1" },
	{ "CTRL + SUPER + BracketRight", "+1" },
	{ "CTRL + SUPER + Up", "r-5" },
	{ "CTRL + SUPER + Down", "r+5" },
}

for _, b in ipairs(workspace_binds) do
	hl.bind(b[1], hl.dsp.focus({ workspace = b[2] }))
end
